 ...
 */
actual class AnnotationSpecWrapper(actual val type: TypeNameWrapper = ClassNameWrapper()) {
...
actual class AnnotationSpecBuilderWrapper {
    actual fun addMember(format: String, vararg args: Any?): AnnotationSpecBuilderWrapper = this
