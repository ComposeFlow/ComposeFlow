...
expect class PropertySpecWrapper {
    companion object {
        fun builder(name: String, type: TypeNameWrapper, vararg modifiers: KModifierWrapper): PropertySpecBuilderWrapper
    }
...
expect class PropertySpecBuilderWrapper {
    fun initializer(format: String, vararg args: Any?): PropertySpecBuilderWrapper
    fun initializer(codeBlock: CodeBlockWrapper): PropertySpecBuilderWrapper
    fun delegate(format: String, vararg args: Any?): PropertySpecBuilderWrapper
